...
CREATE TABLE IF NOT EXISTS Departamento (
    id SERIAL PRIMARY KEY, -- Identificador único do departamento
...
CREATE TABLE IF NOT EXISTS Sala (
    id SERIAL PRIMARY KEY, -- Identificador da sala
...
CREATE TABLE IF NOT EXISTS TipoEquipamento (
    id SERIAL PRIMARY KEY, -- Identificador do tipo
...
CREATE TABLE IF NOT EXISTS StatusEquipamento (
    id SERIAL PRIMARY KEY, -- Identificador do status
    descricao VARCHAR(100) -- Descrição do status
);

-- Tabela principal de equipamentos
CREATE TABLE IF NOT EXISTS Equipamento (
    id SERIAL PRIMARY KEY, -- Código do equipamento
...
CREATE TABLE IF NOT EXISTS Ocorrencia (
    id SERIAL PRIMARY KEY, -- Identificador da ocorrência
...
CREATE TABLE IF NOT EXISTS Manutencao (
    id SERIAL PRIMARY KEY, -- Identificador da manutenção
