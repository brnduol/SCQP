...
class Curso(db.Model):
    ...
    dicentes = db.relationship('Dicente', backref='curso', cascade='all, delete')
...
class Usuario(db.Model):
    ...
    dicente = db.relationship(
        'Dicente', backref='usuario', uselist=False, cascade='all, delete'
    )
...
class Dicente(db.Model):
    __tablename__ = 'Dicente'
    matricula = db.Column(db.Integer, primary_key=True)
